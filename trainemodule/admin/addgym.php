...
$file=new FileUpload();
$elements=array(
        "gymname"=>"","location"=>"","did"=>"","phone"=>"","gymimage"=>"","pass"=>"");
...
$labels=array('gymname'=>"Gym Name","location"=>"Gym location","did"=>"District id","phone"=>"Phone number","gymimage"=>"Gym image","pass"=>"Password");
...
<body>
    ...
    <div class="col-md-6">
        ...
        <?php echo $form->textBox('pass', array('class' => 'form-control')); ?>
        <span class="error-message"><?php echo $validator->error('pass'); ?></span>
    </div>
    </div>
    </div>

...
$file=new FileUpload();
$elements=array(
        "tname"=>"","gymid"=>"","tphone"=>"","timage"=>"","tsex"=>"","tpass"=>"");
...
$labels=array('tname'=>"Traine Name","gymid"=>"Gym","timage"=>"Traine Image","tphone"=>"Phone number","tpass"=>"Trainer pass");
...
<div class="col-md-6">
    ...
    <?php echo $form->passwordbox('tpass', array('class' => 'form-control')); ?>
    <span class="error-message"><?php echo $validator->error('tpass'); ?></span>
</div>
</div>
<div class="col-md-6">
<div class="row">

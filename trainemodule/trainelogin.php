...
if(isset($_POST['login']))
{
    ...
    $data=array(
        ...
        {
        $_SESSION['tname']=$info['tname'];
        $_SESSION['gid']=$info['gymid'];
        header('location:./tindex.html');
        }
        else
        {
...
?>
    ...
    <div class="login-container">
        ...
        <form method="POST">
            <input id="email" class="input-field" type="text" name="tname" placeholder="User name" required>
            <input class="input-field" type="password" name="tpass" placeholder="Password" required>

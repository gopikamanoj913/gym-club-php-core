...
if(isset($_POST['login']))
{
    ...
    $data=array(
        ...
        header('location:/GYM/gymmodule/gindex.html');
        }
        else
        {
...
?>
    ...
    <div class="login-container">
        ...
        <form method="POST">
            <input id="email" class="input-field" type="text" name="gymname" placeholder="User name" required>
            ...
            <div class="signup">
                <a href="/GYM/gymmodule/gindex.html">Sign Up</a>
            </div>
        </form>
    </div>

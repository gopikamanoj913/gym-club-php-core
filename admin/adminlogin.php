...
$dao=new DataAccess();
$rules=array(
    'adminid'=>array('required'=>true),
    'apass'=>array('required'=>true)
);
...
if(isset($_POST['login']))
{
    ...
    $data=array(
        ...
        header('location:/GYM/admin/issue.php');
        }
        else
        {
...
?>
    ...
    <div class="login-container">
        ...
        <form method="POST">
            <input id="email" class="input-field" type="text" name="adminid" placeholder="User name" required>
            <input class="input-field" type="password" name="apass" placeholder="Password" required>
